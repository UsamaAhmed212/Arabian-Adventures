...
class ElementorInitialization {
	...
	public function controls_registered() {
		...
		$widget_file = ELEMENTOR_DIR . '/controls/controls-register.php';
		$template_file = locate_template( $widget_file );

		if ( !$template_file || !is_readable( $template_file ) ) {
			$template_file = ELEMENTOR_DIR . '/controls/controls-register.php';
		}
	...
	public function widgets_registered() {
		...
		$widget_file = ELEMENTOR_DIR . '/widgets/widgets-register.php';
		$template_file = locate_template( $widget_file );

		if ( !$template_file || !is_readable( $template_file ) ) {
			$template_file = ELEMENTOR_DIR . '/widgets/widgets-register.php';
		}
	...
	public function elementor_custom_categories( $elements_manager ) {
		...
		// Elementor Custom ( arabian-adventures ) Category
		$elements_manager->add_category( 'arabian-adventures', array(
			'title' => esc_html__( 'adventureUAE', 'arabian_adventures' )
		) );
	...
	public function elementor_editor_styles() {
		...
		wp_register_style( 'arabian_adventures-elementor-editor', ELEMENTOR_DIR_URI . '/assets/css/elementor-editor.css', array(), '1.0.0', 'all' );
		wp_enqueue_style( 'arabian_adventures-elementor-editor' );
	...
	public function include_custom_file() {
		...
		// require_once ELEMENTOR_DIR . '/widgets/contact-form/mail.php';
  	}
