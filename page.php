...
<head>
    ...
    <!-- Home Css -->
    <link href="./assets/styles/css/page.css" rel="stylesheet">
...
<body>
    ...
    <!-- Title Section -->
     <div class="page-title-header">
        <div class="container-xxl px-xl-5 px-sm-4 px-3 pt-4">
            <div class="row m-0">
                <div class="col-12 p-0">
                    <div class="page-title-category">Desert Safaris</div>
                    <div class="page-title_wrapper">
                        <h1 class="page-title">Evening Desert Safari in Dubai</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="tourDetailsSelection">
                        <div class="timeListStrip">
                            ...
                            <div class="single-time-slot">Enter anytime within operating hours: 
                                <span class="operating-hours">10:00am - 10:00pm</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="Selection__Layout_Container">
                                <div class="Selection__DescriptionLayout">
                                    ...
                                    <div class="Selection__TourDescription">
                                        <div class="title">Burj Khalifa At The Top Tickets: Levels...</div>
                                        <div class="selected-time">
                                            ...
                                            <div class="time-slot">5:00am</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Footer Section -->
    <footer id="footer">
        <div class="container-xxl px-xl-5 px-sm-4 px-3">
